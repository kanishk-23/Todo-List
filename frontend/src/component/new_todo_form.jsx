...
import { createTodo } from "../service/todo_service";
        ...
        <div className="flex flex-col gap-2 w-full">
            ...
            <div className="flex flex-col gap-2">
                <div className="flex-1 flex flex-col">
                    <label className="text-xs font-medium text-gray-300">Task description</label>
            ...
            <div className="flex gap-2 border-t border-gray-200 pt-4">
                <button type="submit" onClick={onSubmit} className="flex-1 rounded-sm border-none text-sm font-medium text-blue-600 bg-white" // hover:bg-blue-50"
                >Add</button>
            </div>
        </div>
    )
